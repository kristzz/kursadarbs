            ...
            <form className="flex flex-col gap-8">
                <div className="flex flex-col lg:flex-row gap-8">
                    <div className="flex flex-col md:flex-row gap-4 md:gap-0">
                        ...
                        <input type="text" placeholder={t("enterName")} required className="bg-transparent border-b border-white focus:border-primaryc focus:outline-none" />
                    </div>
                    <div className="flex flex-col md:flex-row gap-4 md:gap-0">
                ...
                <div className="flex flex-col gap-8">
                    <div className="flex flex-col md:flex-row gap-4 md:gap-0">
                        ...
                        <input type="email" placeholder={t("enterEmail")} required className="bg-transparent border-b border-white focus:border-primaryc focus:outline-none" />
                    </div>
                    <div className="flex flex-col md:flex-row gap-4 md:gap-0">
                        <h3 className="sm:w-[558px]">{t("passwordLogin")}</h3>
                        <input type="password" placeholder={t("enterPassword")} required className="bg-transparent border-b border-white focus:border-primaryc focus:outline-none" />
                    </div>
                    <div className="flex flex-col md:flex-row gap-4 md:gap-0">
                        <h3 className="sm:w-[558px]">{t("confirmIt")}</h3>
                        <input type="password" placeholder={t("confirmPassword")} required className="bg-transparent border-b border-white focus:border-primaryc focus:outline-none" />
                    </div>
                </div>
                ...
                <button
                    type="submit"
                    disabled={!isAgreed}
                    className={`bg-primaryc text-white px-6 py-3 rounded-lg transition-opacity ${isAgreed ? "opacity-100" : "opacity-50 cursor-not-allowed"}`}
                >
                    {t("submit")}
                </button>
            </form>
